import type { CoverageStats } from '../../lib/pairing-matrix';
...
export function PairingMatrix({ stats, totalStudents, getDisplayName }: PairingMatrixProps) {
  const students = Array.from({ length: totalStudents }, (_, i) => i + 1);

  return (
    <div className="max-w-4xl mx-auto p-4 space-y-4">
      <h2 className="text-lg font-semibold text-gray-800">Pairing Matrix</h2>
